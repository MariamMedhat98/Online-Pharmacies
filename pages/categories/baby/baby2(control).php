...
<html>
    ...
    <body>
        ...
        <div class="content sup-content">
            <a href="../../pharmacies/10911(control).php"><img src="../../../images/sub/19011.jpg" alt="img" class="logo-img control_logo"></a>
           <form class="ser-form">
             <a href="control/add.php" class="btn  btn-primary btn2 control_btn" type="submit">ADD</a>
             <a href="control/edit.php" class="btn  btn-primary btn2 control_btn" type="submit">Edit</a>
             <br>
      ...
      <div class="content1">
        <div class="supdata1">
          ...
          <div> <h1> Categories </h1> 
            <ul class="cat-menu"> 
              <li id="toggle1"> <a class="cat-submenu " href="../../categories/men/men2(control).php">Men Care</a>
            ...
            <li id="toggle2"> <a class="cat-submenu " href="../../categories/women/women2(control).php">Women Care</a> 
              <i class="fa fa-angle-down"></i>
            ...
            <li id="toggle3"> <a class="cat-submenu " href="../../categories/baby/baby2(control).php">Baby Care</a> 
              <i class="fa fa-angle-down"></i>
            ...
            <li id="toggle4"> <a class="cat-submenu " href="../../categories/hair/hair2(control).php">Hair Care</a> 
              <i class="fa fa-angle-down"></i>
        ...
        <div class="data supdata2">
          <div class="slider man-banner man-ban">
              <img src="../../../images/slider/baby-needs-en.jpg">
          </div>
      ...
      <!------------------- Data --------------------------->
        <div class="phar-content">
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/9.jpg" class="card-img-top" alt="baby1" height="170px">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/8.jpg" class="card-img-top" alt="baby2" height="170px">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/7.jpg" class="card-img-top" alt="baby3">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/12.jpg" class="card-img-top" alt="baby4">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/6.jpg" class="card-img-top" alt="baby5" height="160px">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/1.jpg" class="card-img-top" alt="baby6">
              <div class="card-body">
                <h3 class="card-title">EGP40.00</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/3.jpg" class="card-img-top" alt="baby7">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/11.jpg" class="card-img-top" alt="baby8">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/10.jpg" class="card-img-top" alt="baby9" height="180px">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/4.jpg" class="card-img-top" alt="baby10" height="180px">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/5.jpg" class="card-img-top" alt="baby11" height="180px">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/baby/2.jpg" class="card-img-top" alt="baby12" height="180px">
              <div class="card-body">
