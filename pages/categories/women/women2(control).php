      ...
      <div class="content1">
        ...
        <div class="data supdata2">
          <div class="slider man-banner man-ban">
              <img src="../../../images/slider/women-care-en.jpg">
          </div>
      ...
      <!------------------- Data --------------------------->
        <div class="phar-content">
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/5.jpg" class="card-img-top" alt="women1" height="180px">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/1.jpg" class="card-img-top" alt="women2" height="180px">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/4.jpg" class="card-img-top" alt="women3" height="180px">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/9.jpg" class="card-img-top" alt="women4" height="180px">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/2.jpg" class="card-img-top" alt="women5">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/7.jpg" class="card-img-top" alt="women6">
              <div class="card-body">
                <h3 class="card-title">EGP40.00</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/6.jpg" class="card-img-top" alt="women7">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/3.jpg" class="card-img-top" alt="women8">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/8.jpg" class="card-img-top" alt="women9">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/10.jpg" class="card-img-top" alt="women10">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/11.jpg" class="card-img-top" alt="women11">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/women/12.jpg" class="card-img-top" alt="women12">
              <div class="card-body">
