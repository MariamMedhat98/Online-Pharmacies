      ...
      <div class="content1">
        ...
        <div class="data supdata2">
          <div class="slider man-banner man-ban">
              <img src="../../../images/slider/hair-care-en.jpg">
          </div>
      ...
      <!------------------- Data --------------------------->
        <div class="phar-content">
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/5.jpg" class="card-img-top" alt="hair1" >
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/1.jpg" class="card-img-top" alt="hair2">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/4.png" class="card-img-top" alt="hair3">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/9.jpg" class="card-img-top" alt="hair4" height="165px">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/2.jpg" class="card-img-top" alt="hair5">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/11.jpg" class="card-img-top" alt="hair6" height="165px">
              <div class="card-body">
                <h3 class="card-title">EGP40.00</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/6.jpg" class="card-img-top" alt="hair7" height="165px">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/3.jpg" class="card-img-top" alt="hair8" height="165px">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/8.jpg" class="card-img-top" alt="hair9">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/10.jpg" class="card-img-top" alt="hair10">
              <div class="card-body">
                <h3 class="card-title">EGP51.50</h3>
                <a href="#" class="btn btn-primary card-btn">ADD TO CARD</a>
              </div>
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/7.jpg" class="card-img-top" alt="hair11" height="160px">
              <div class="card-body">
          ...
          <div class="data1 card-data">
            <div class="card">
              <img src="../../../images/hair/12.jpg" class="card-img-top" alt="hair12" height="160px">
              <div class="card-body">
