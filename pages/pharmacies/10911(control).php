...
<html>
    ...
    <body>
        ...
        <div class="content sup-content">
          <a href="../pharmacies/10911(control).php"><img src="../../images/sub/19011.jpg" alt="img" class="logo-img"></a>
            <form class="ser-form">
      ...
      <div class="content1">
        <div class="supdata1">
          ...
          <div> <h1> Categories </h1> 
            <ul class="cat-menu"> 
              <li id="toggle1"> <a href="../categories/men/men2(control).php">Men Care</a>
            ...
            <li id="toggle2"> <a href="../categories/women/women2(control).php">Women Care</a> 
              <i class="fa fa-angle-down"></i>
            ...
            <li id="toggle3"> <a href="../categories/baby/baby2(control).php">Baby Care</a> 
              <i class="fa fa-angle-down"></i>
            ...
            <li id="toggle4"> <a href="../categories/hair/hair2(control).php">Hair Care</a> 
              <i class="fa fa-angle-down"></i>
