...
<html>
    ...
    <body>
        ...
        <div class="content sup-content">
          <a href="../pharmacies/roshdy(control).php"><img src="../../images/sub/roshdy.jpg" alt="img" class="logo-img"></a>
            <form class="ser-form">
      ...
      <div class="content1">
        <div class="supdata1">
          ...
          <div> 
            <h1> Categories </h1> 
            <ul> 
              <li id="toggle1"> <a href="../categories/men/men3(control).php">Men Care</a>
            ...
            <li id="toggle2"> <a href="../categories/women/women3(control).php">Women Care</a> 
              <i class="fa fa-angle-down"></i>
            ...
            <li id="toggle3"> <a href="../categories/baby/baby3(control).php">Baby Care</a> 
              <i class="fa fa-angle-down"></i>
            ...
            <li id="toggle4"> <a href="../categories/hair/hair3(control).php">Hair Care</a> 
              <i class="fa fa-angle-down"></i>
