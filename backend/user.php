<?php
  ...
  if ( isset($_SESSION["user"])){
    echo '<style>.profile{visibility: visible !important;margin-right:}</style>';
...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <nav>
                <div>
                  <a href="user.php" class="selected">Home</a>
                  <a href="../pages/about(user).html">About</a>
                  <a href="../pages/contact us(user).html">Contact Us</a>
                    <div class="welcome" style=" display: inline-block; color:black;"> 
                    <?php
                            if(isset($_SESSION["user"])){
                               echo $_SESSION['user'] ;
                            }
                    ...
                    <div style="display: inline-block; margin: 0% 1%">
                        <button class="btn1" style="margin: 0%; padding: 0%; width: 140%; color:black;"><a href="logout.php" style="color: #fff;">Log out </a></button>
                    </div>
                </div>
            </nav>
